...
## Read in the files
maziba<- read.csv("Final_Manuscript_Figures/Supplementals_Final_12_2025/Combined_analysis/Maziba_p-values.csv", header = T) %>%
  dplyr::mutate(Site = "Maziba")

muko<- read.csv("Final_Manuscript_Figures/Supplementals_Final_12_2025/Combined_analysis/Muko_p-values.csv", header = T) %>%
  dplyr::mutate(Site = "Muko")

kamwezi<- read.csv("Final_Manuscript_Figures/Supplementals_Final_12_2025/Combined_analysis/Kamwezi_p-values.csv", header = T) %>%
...
p
ggsave("Final_Manuscript_Figures/Supplementals_Final_12_2025/Combined_analysis/r_distribution.png", p, width = 10, height = 8, units = "in", bg = "white")
##--------------------------------------------------------------
...
p1
ggsave("Final_Manuscript_Figures/Supplementals_Final_12_2025/Combined_analysis/r_distribution1.png", p1, width = 10, height = 8, units = "in", bg = "white")
##-------------------------------------------------------------
...
ggsave("Final_Manuscript_Figures/Supplementals_Final_12_2025/Combined_analysis/r_distribution2.png", p2, width = 10, height = 8, units = "in", bg = "white")
